    ...
    <body>
        <table width="100%" border="1" style="border-collapse: collapse">
            <tr>
                ...
                <td width="5%" bgcolor="black"><font face="MS Sans Serif" size="3" color="pink"><b>ชื่อสิ้นค้า</b></font></td>
                <td width="5%" bgcolor="black"><font face="MS Sans Serif" size="3" color="pink"><b>รายละเอียด</b></font></td>
            ...
            <xsl:for-each select="Productcode/product_data">
                <tr>
